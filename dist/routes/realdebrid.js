...
const logger = new logger_1.Logger('RealDebridAPI');
...
router.post('/validate', async (req, res) => {
    try {
        ...
        const response = await axios_1.default.get('https://api.real-debrid.com/rest/1.0/user', {
            headers: {
...
router.get('/health', async (req, res) => {
    try {
        ...
        await axios_1.default.get('https://api.real-debrid.com', {
            timeout: 5000
        });
        res.json({
            status: 'ok',
...
//# sourceMappingURL=realdebrid.js.map