...
exports.setupDemoStaticRoutes = void 0;
const logger_1 = require("../utils/logger");
const logger = new logger_1.Logger('DemoStaticRoutes');
const setupDemoStaticRoutes = (app) => {
...
exports.setupDemoStaticRoutes = setupDemoStaticRoutes;
